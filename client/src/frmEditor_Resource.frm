...
Private Sub cmbType_Click()
    ...
    Resource(EditorIndex).Type = cmbType.ListIndex
...
Private Sub scrlSound_Change()
    ...
    Resource(EditorIndex).Sound = scrlSound.Value

    ' Error handler
    Exit Sub
errorhandler:
    HandleError "scrlSound_Change", "frmEditor_Resource", Err.Number, Err.Description, Err.Source, Err.HelpContext
    Err.Clear
    Exit Sub
End Sub
